...
dotfiles_list = ['.zshrc', '.zshenv', '.screenrc', '.vimrc', '.screeninator', '.boxes', '.gitconfig', '.gitignore', '.aspell.conf', '.tigrc', '.globalrc', '.offlineimaprc', '.percol.d', '.ctags', '.my.cnf', '.gitmessage.txt']
